                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<QueryDocumentSnapshot> filteredDocs = docs.where((doc) {
                      var data = doc.data() as Map<String, dynamic>;
                      Timestamp timestamp = data['timestamp'] as Timestamp;
                      String formattedDate = DateFormat('MMMM dd, yyyy').format(timestamp.toDate());

                      return _searchQuery.isEmpty || formattedDate.toLowerCase().contains(_searchQuery.toLowerCase());
                    }).toList();
